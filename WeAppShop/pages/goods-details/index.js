...
Page({
  ...
  onLoad: function (e) {
    ...
    wx.request({
      url: app.globalData.baseUrl + '/goods/GetGoodInfo',
      data: {
        id: e.id
      },
      success: function (res) {
        ...
        if (res.data.data.properties) {
          ...
          that.setData({
            ...
            totalScoreToPay: res.data.data.price
          });
        }
        ...
        // }
        res.data.data.coverPics = JSON.parse(res.data.data.coverPics)
        that.setData({
  ...
  */
  ...
  bulidShopCarInfo: function () {
    ...
    shopCarMap.pic = this.data.goodsDetail.coverPics;
