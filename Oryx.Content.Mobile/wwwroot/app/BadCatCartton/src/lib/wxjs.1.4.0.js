  ...
  if (!e.jWeixin) {
    ...
    var O = !1,
      ...
      N = {
        ...
        unbindMenuShareTimeline: function () {
          shareDataDict["shareTimeline"] && shareDataDict["shareTimeline"].pop()
        },
        onMenuShareTimeline: function (e) {
          if (!shareDataDict["shareTimeline"]) {
            shareDataDict["shareTimeline"] = []
          }
          shareDataDict["shareTimeline"].push({
            title: e.title || I,
            desc: e.title || I,
            img_url: e.imgUrl || "",
          ...
          t(h.onMenuShareTimeline, {
            complete: function () {
              var topData = shareDataDict["shareTimeline"][shareDataDict["shareTimeline"].length - 1];
              i("shareTimeline", topData, e)
            }
          }, e)
        },
        unbindShareAppMessage: function () {
          shareDataDict["sendAppMessage"] && shareDataDict["sendAppMessage"].pop()
        },
        onMenuShareAppMessage: function (e) {
          if (!shareDataDict["sendAppMessage"]) {
            shareDataDict["sendAppMessage"] = []
          }
          shareDataDict["sendAppMessage"].push({
            title: e.title || I,
            desc: e.desc || "",
            link: e.link || location.href,
            img_url: e.imgUrl || "",
          ...
          t(h.onMenuShareAppMessage, {
            complete: function (n) {
              var topData = shareDataDict["sendAppMessage"][shareDataDict["sendAppMessage"].length - 1];
              "favorite" === n.scene ? i("sendAppMessage", topData) : i("sendAppMessage", topData, e)
            }
          }, e)
        },
