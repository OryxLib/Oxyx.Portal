...
namespace Oryx.Shop.BusinessApi.Migrations
{
    ...
    [Migration("20180720174007_updateOrderExpression")]
    partial class updateOrderExpression
    {
            ...
            modelBuilder.Entity("Oryx.Content.Model.ContentPayLog", b =>
                {
                    ...
                    b.Property<decimal>("CostRewardPoints");
            ...
            modelBuilder.Entity("Oryx.Content.Model.ContentEntry", b =>
                {
                    ...
                    b.HasOne("Oryx.Content.Model.Comment", "Comments")
                        .WithMany()
