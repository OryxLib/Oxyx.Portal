...
namespace Oryx.DataPlatform.Portal.Controllers
{
    public class AdminUserAccountController : Controller
    {
        ...
        public AdminUserAccountController(UserAccountBusiness _userAccountBusiness)
        {
        ...
        public IActionResult Table(DataTableAjaxPostModel model)
        {
            ...
            dbQuery = dbQuery.Where(x => x.Roles.Any(c => c.RoleName == UserAccountBusiness.AdminUserRoleKey));
